...
@strawberry_django.type(models.Group, filters=filters.GroupFilter, pagination=True, description="""
...
@strawberry_django.type(models.User, filters=filters.UserFilter, pagination=True, description="""
...
@strawberry_django.type(models.Profile, filters=filters.ProfileFilter, pagination=True, description="""
...
@strawberry_django.interface(smodels.SocialAccount, description="""
...
@strawberry_django.type(smodels.SocialAccount, filters=filters.SocialAccountFilter, pagination=True, description="""
