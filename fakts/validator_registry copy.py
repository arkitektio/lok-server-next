...
class ValidatorRegistry:
    ...
    def register_validator(self, service_name, validator, description="This is a service", logo=None):
        assert service_name not in self.service_validators, f"Service {service_name} already registered. Cannot register twice."
